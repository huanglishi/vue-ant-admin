<template>
  <PageWrapper title="Icon组件示例">
    ...
    />
    <a-button type="link" @click="">1. Iconify 图标大全 </a-button>
    <a-button type="link" @click="toNetlify">2. netlify图标大全</a-button>
  </PageWrapper>
</template>
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      return {
        ...
        toNetlify: () => {
          openWindow('https://icones.netlify.app/collection/ant-design');
        },
      };
    },
  });
